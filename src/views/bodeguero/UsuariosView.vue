...
// Diccionario para mapear los IDs de rol a sus nombres correspondientes
...
// Formatea un string de fecha ISO a un formato local abreviado
...
// Prepara el usuario seleccionado para edición
const editarUsuario = (usuario) => {
    // Aquí se implementará la apertura de un modal o redirección con los datos del usuario
    console.log('Iniciando edición para el usuario:', usuario.id)
}

// Solicita confirmación y ejecuta la eliminación del usuario
const eliminarUsuario = async (idUsuario) => {
    const confirmacion = confirm('¿Estás seguro de que deseas eliminar este usuario? Esta acción no se puede deshacer.')
    if (confirmacion) {
        // Aquí se llamará a la acción del store para eliminar: await usuariosStore.deleteUsuario(idUsuario)
