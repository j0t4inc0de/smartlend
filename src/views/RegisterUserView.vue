<template>
  <div class="relative min-h-screen w-full overflow-hidden flex items-center justify-center p-4">
    ...
    <div class="relative z-20 w-full max-w-5xl animate-fade-in-up">
      <div
        class="bg-black/40 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl overflow-hidden"
      >
        <div
        ...
        >
          <div class="flex items-center gap-4">
            ...
            <div>
              ...
              <p class="text-gray-300 text-sm mt-1">
                Sistema de reconocimiento biométrico SmartLend
              </p>
            </div>
          </div>

          <div
            v-if="registrationMethod === 'face'"
            class="flex items-center gap-2 bg-white/5 rounded-full px-4 py-2 border border-white/5"
          >
            <span
              :class="[
                'px-3 py-1 rounded-full text-xs font-bold transition-colors',
                currentStep === 1 ? 'bg-red-600 text-white shadow-lg' : 'text-gray-400',
              ]"
              >1. Datos</span
            >
            ...
            <span
              :class="[
                'px-3 py-1 rounded-full text-xs font-bold transition-colors',
                currentStep === 2 ? 'bg-red-600 text-white shadow-lg' : 'text-gray-400',
              ]"
              >2. Rostro</span
            >
          </div>
          <div
            ...
            class="flex items-center gap-2 bg-white/5 rounded-full px-4 py-2 border border-white/5"
          >
            <span class="px-3 py-1 rounded-full text-xs font-bold bg-red-600 text-white shadow-lg"
              >Registro por correo</span
            >
          </div>
        </div>
        ...
        <div class="p-6 md:p-8">
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
            <div class="space-y-6">
              ...
              <div class="flex items-center justify-between gap-3">
                ...
                <!-- Selector compacto -->
                <div
                  class="inline-flex items-center rounded-full border border-white/10 bg-white/5 p-1"
                >
                  <button
                    type="button"
                    @click="registrationMethod = 'face'"
                    class="px-3 py-1.5 rounded-full text-xs font-semibold transition-all"
                    :class="
                      registrationMethod === 'face'
                        ? 'bg-red-600/70 text-white shadow'
                        : 'text-gray-300 hover:text-white'
                    "
                    aria-pressed="registrationMethod === 'face'"
                  >
                    Facial
                  </button>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div class="col-span-1 md:col-span-2 group">
                  ...
                  <p v-if="emailError" class="text-red-400 text-xs mt-2 ml-1 h-4">
                    {{ emailError }}
                  </p>
                </div>
                ...
                <template v-if="registrationMethod === 'email'">
                  <div class="group">
                    ...
                    />
                    <p v-if="passwordError" class="text-red-400 text-xs mt-2 ml-1 h-4">
                      {{ passwordError }}
                    </p>
                  </div>
                  ...
                  <div class="group">
                    ...
                    />
                    <p v-if="passwordConfirmError" class="text-red-400 text-xs mt-2 ml-1 h-4">
                ...
                <div class="group">
                  ...
                  <div class="relative">
                    <select
                      ...
                      :disabled="!isRoleWithCarrera || loadingData"
            ...
            <div class="flex flex-col h-full">
              ...
              <div
                v-if="registrationMethod === 'email'"
                class="flex-1 bg-black/40 rounded-2xl border border-white/10 p-6 flex items-center justify-center"
              >
                <div class="text-center">
                  <div class="text-white font-semibold">
                    Te estas registrando con correo y contraseña
                  </div>
                  <div class="text-gray-400 text-sm mt-1">
                    La captura facial es opcional aunque 3 veces más rápida.
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div class="absolute inset-0 pointer-events-none">
                  <div class="absolute inset-0 flex items-center justify-center">
                    <div
                      :class="[
                        'w-56 h-72 border-2 rounded-[3rem] transition-all duration-500 box-content shadow-[0_0_100px_rgba(0,0,0,0.5)_inset]',
                        isCameraActive
                  ...
                  <div class="absolute top-4 left-4 right-4 flex justify-between items-start">
                    ...
                    >
                      ...
                      <span class="text-xs font-bold text-red-100 tracking-wide uppercase"
                        >En Vivo</span
                      >
                    </div>
                    <div
                    ...
                    >
                      ...
                      <span class="text-xs font-bold text-gray-300 tracking-wide uppercase"
                        >Inactivo</span
                      >
                    </div>
                  </div>
          ...
          <div
            class="mt-10 pt-6 border-t border-white/10 flex flex-col-reverse md:flex-row justify-end gap-4"
          >
            <button
