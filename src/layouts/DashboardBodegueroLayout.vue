          ...
          <div class="flex items-center gap-4">
            <div v-if="alertasCount > 0" class="relative">
              ...
              >
                ...
                <div v-else-if="alerta.tipo_alerta === 'Mantencion'" class="flex items-start gap-3">
                  <div
                    class="w-8 h-8 rounded-full bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center text-white shrink-0"
                  >
                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path
                        stroke-linecap="round"
                  ...
                  <div class="flex-1 min-w-0">
                    <p class="text-white text-sm font-medium truncate">Requiere Mantención</p>

                    <p class="text-gray-400 text-xs font-mono mt-0.5 truncate">
                      Código:
                      <span class="text-orange-400 font-bold">
                        {{ alerta.herramienta_detalle?.codigo_barras || 'N/A' }}
                      </span>
                    </p>
